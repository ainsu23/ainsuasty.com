...
Dividir una base de un libro de excel en varias pestañas teniendo en cuenta una 
columna, resulta facil con el uso de **purrr**.

-   separar archivo por columna

```{style="color: blue;"}{r echo=TRUE, message=FALSE, warning=FALSE}
library(dplyr)
...
-   Guarda cada base filtrada con el registro de la lista en una lista de 
dataframes, adiciona nombres a los elementos de la lista y mantiene las bases 
que contengan registros
