...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/ainsu23/resume/ainsuasty.pdf)")
}
```
...
The source code is available [https://github.com/ainsu23/resume](https://github.com/ainsu23/resume).
